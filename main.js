...
module.exports = __webpack_require__(/*! C:\projects\messages-challenge\src\main.ts */"zUnb");
...
const routes = [
    {
        path: 'messages',
        loadChildren: () => __webpack_require__.e(/*! import() | features-messages-messages-module */ "features-messages-messages-module").then(__webpack_require__.bind(null, /*! ./features/messages/messages.module */ "ahgd")).then((m) => m.MessagesModule),
    },
    {
        path: '**',
        redirectTo: '/messages',
